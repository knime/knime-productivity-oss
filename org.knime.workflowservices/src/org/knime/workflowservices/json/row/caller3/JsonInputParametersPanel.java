...
final class JsonInputParametersPanel {
     ...
     *
     * Optionally call {@link #loadConfiguration(CallWorkflowRowBased3Configuration)} afterwards to re-apply previous
    ...
    public void setError(final String message) {
        m_errorLabel.setText("<html>" + message.replace("\n", "<br/>") + "</html>");
     ...
     */
    public void saveToConfiguration(final CallWorkflowRowBased3Configuration configuration)
     ...
     *            JSON object)
     */
    public void loadConfiguration(final CallWorkflowRowBased3Configuration configuration) {
