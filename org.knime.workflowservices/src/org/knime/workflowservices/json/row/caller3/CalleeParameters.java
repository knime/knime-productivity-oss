...
final class CalleeParameters implements NodeParameters {
        ...
        public Optional<TextMessage.Message> computeState(final NodeParametersInput parametersInput) {
            ...
            if (inputParameters.length == 0) {
                return Optional.of(new TextMessage.Message("No input parameters",
                    "The selected workflow has no input parameters.", TextMessage.MessageType.INFO));
            }
     ...
     */
    static final class InputNodesErrorMessageProvider extends ErrorMessageProvider<Map<String, ExternalNodeData>> {

        InputNodesErrorMessageProvider() {
            super("Failed to load workflow input parameters", WorkflowInputNodesProvider.class);
        }
    ...
    static final class ContainerInputParametersProvider implements StateProvider<ContainerInputParameters[]> {
        ...
        private Supplier< //
                CallWorkflowParameters.WithError<Map<String, ExternalNodeData>, Exception>> m_inputNodesProvider;
