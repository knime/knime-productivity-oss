...
import org.knime.workflowservices.json.table.caller2.CalleeParameters.HasWorkflowNodesErrorMessage;

/**
 * Node parameters for Call Workflow (Table Based).
 *
...
class CallWorkflowTable2NodeParameters implements NodeParameters {
     ...
     */
    static final String HAS_WORKFLOW_NODES_ERROR_CFG_KEY = "hasWorkflowNodesError";

    @ValueProvider(HasWorkflowNodesErrorMessage.class)
    @ValueReference(HasWorkflowNodesErrorMessage.class)
    @Persist(configKey = HAS_WORKFLOW_NODES_ERROR_CFG_KEY)
