...
final class CalleeParameters implements NodeParameters {
    ...
    @Widget(title = "Use fully qualified names for parameters", description = "TODO: Description from before.")
    ...
    static final class DialogState implements NodeParameters {
        ...
        abstract static class ParameterUpdater implements StateProvider<String> {
            ...
            public void init(final StateProviderInitializer initializer) {
                ...
                m_selectedParameterIdSupplier = initializer.computeFromValueSupplier(m_selectedParameterIdRefClass);
    ...
    static final class WorkflowInputOutputNodesPairProvider implements
        StateProvider<CallWorkflowParameters.WithError<Pair<Map<String, JsonValue>, Map<String, JsonValue>>, Exception>> {
    ...
    static final class InputParameterKeysProvider implements StateProvider<ParameterIdsUtil.InputParameterKeys> {
        ...
        private Supplier<WithError<Pair<Map<String, JsonValue>, Map<String, JsonValue>>, Exception>> m_inputNodesProvider;
     ...
     */
    static final class WorkflowNodesErrorMessageProvider implements StateProvider<Optional<TextMessage.Message>> {
