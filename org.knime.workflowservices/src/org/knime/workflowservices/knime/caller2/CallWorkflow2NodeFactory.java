...
public class CallWorkflow2NodeFactory extends ConfigurableNodeFactory<CallWorkflow2NodeModel> implements NodeDialogFactory, KaiNodeInterfaceFactory {
    ...
    private static final List<PortDescription> OUTPUT_PORTS = List.of(
            dynamicPort("Outputs", "Workflow outputs", """
    ...
    public NodeDialog createNodeDialog() {
        return new DefaultNodeDialog(SettingsType.MODEL, CallWorkflow2NodeParameters.class, new UpdatePortsOnApplyModifier());
    }
