...
final class ErrorAndLoadingUtil {
    ...
    static final class WorkflowParametersErrorMessageProvider implements StateProvider<Optional<TextMessage.Message>> {
        ...
        private Supplier<CallWorkflowParameters.WithError<Pair<Map<String, IWorkflowBackend.ResourceContentType>, Map<String, IWorkflowBackend.ResourceContentType>>, Exception>> m_resourceDescriptionsProvider;
