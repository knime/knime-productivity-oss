...
final class WorkflowInputNodeModel extends AbstractPortObjectRepositoryNodeModel implements InputNode {
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings) {
        NodeParameters.saveSettings(WorkflowInputSettings.class, m_settings, settings);
    }

    @Override
    protected void validateSettings(final NodeSettingsRO settings) throws InvalidSettingsException {
        var s = NodeParameters.loadSettings(settings, WorkflowInputSettings.class);
        WorkflowIOParameterNameValidation.validateParameterName(s.m_parameterName);
    }

    @Override
    protected void loadValidatedSettingsFrom(final NodeSettingsRO settings) throws InvalidSettingsException {
        m_settings = NodeParameters.loadSettings(settings, WorkflowInputSettings.class);
    }
