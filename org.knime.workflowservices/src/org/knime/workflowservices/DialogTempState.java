...
class DialogTempState implements NodeParameters {
    ...
    static final class SetToUuidInEquality implements StateProvider<Boolean> {
        ...
        /**
         * We deliberately do not set the processing uuid as trigger. Otherwise, this would be called in the same thread
         * as the workflow fetching and is blocked until the workflow fetching finishes.
         */
        @Override
        public void init(final StateProviderInitializer initializer) {
