 ...
 */
public class NodeDiffClearFilterButton extends ControlContribution {

    private final NodeDiffFilterContribution m_textField;
    ...
    protected Control createControl(final Composite parent) {
        ...
        del.setToolTipText("Clear filter criteria");
        return del;
    }
