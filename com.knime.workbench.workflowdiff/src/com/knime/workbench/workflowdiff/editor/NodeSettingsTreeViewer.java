 ...
 * @author ohl
 */
public class NodeSettingsTreeViewer extends TreeViewer {
    ...
    public NodeSettingsTreeViewer(final Composite parent) {
        ...
        setLabelProvider(new NodeSettingsTableLabelProvider());
     ...
     * expanded.
     *
     * @param item to find in this tree and to set the expand state
     * @param expand or not.
     */
    ...
    /**
     * @param rect to set as new bounds
    ...
    public static void colorItems(final SettingsItem[] itemSet1, final SettingsItem[] itemSet2) {
        ...
        for (SettingsItem item : itemSet1) {
            items1.put(item.getText(0), item); // column 0 contains the settings "name" - should be the unique id
        }
     ...
     *
     * @param parent of the items that should be colored
     * @param col background color to set
     */
    ...
    protected void associate(final Object element, final Item item) {
        System.out.println("Associating " + element + " with " + System.identityHashCode(item));
        super.associate(element, item);
    }

    private static final Color DIFFERENT = new Color(Display.getDefault(), 255, 196, 196);

    private static final Color CONTAINSDIFF = Display.getDefault().getSystemColor(SWT.COLOR_GRAY);

    private static final Color DEFAULT = Display.getDefault().getSystemColor(SWT.COLOR_WHITE);
    ...
    public class SettingsItem {
        ...
        /**
         * @param index of the column to retrieve the text from
         ...
         * @param column to return the color for
         ...
         *
         * @param s1 the object or null
         * @param s2 the other object or null
